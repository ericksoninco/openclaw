...
export const DEFAULT_STAGE_WARN_TOTAL_MS = 10_000;
export const DEFAULT_STAGE_WARN_STAGE_MS = 5_000;
...
export function shouldWarnStageSummary(
...
export function formatStageSummary(prefix: string, summary: StageSummary): string {
  const stages =
